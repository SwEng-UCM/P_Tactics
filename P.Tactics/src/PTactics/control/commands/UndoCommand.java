...
public class UndoCommand extends Command {
	public UndoCommand() {
		super(Utils.CommandInfo.COMMAND_UNDO_NAME, Utils.CommandInfo.COMMAND_UNDO_SHORTCUT,
				Utils.CommandInfo.COMMAND_UNDO_DETAILS, Utils.CommandInfo.COMMAND_UNDO_HELP);
	}
